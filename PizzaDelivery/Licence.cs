...
<Exponent>AQAB</Exponent>
    ...
    public class LicenceValidator
    {
        ...
        {
            foreach (var file in Directory.EnumerateFiles(path, "*.pz_licence"))
            {
...

        {
            ...
            rsaKey.FromXmlString(Licence.PublicKey);
            ...
            {
                dto = (Licence)new XmlSerializer(typeof(Licence)).Deserialize(fileStream);
            }
